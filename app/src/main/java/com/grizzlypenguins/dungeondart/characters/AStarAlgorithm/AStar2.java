...
public class AStar2 {
	...
	private ArrayList<MyPoint> shortestPath;
	...
	public ArrayList<MyPoint> calcShortestPath(int startX, int startY, int goalX, int goalY) {
		//this.startX = startX;
		//this.startY = startY;
		//this.goalX = goalX;
		//this.goalY = goalY;
	...
	private ArrayList<MyPoint> reconstructPath(Node node) {
